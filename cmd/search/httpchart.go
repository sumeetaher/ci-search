...
var colors = []color.Color{
	color.RGBA{R: 0x80, A: 0xff},                   // maroon
	color.RGBA{R: 0xfa, G: 0xbe, B: 0xbe, A: 0xff}, // pink
	color.RGBA{R: 0xe6, G: 0xbe, B: 0xff, A: 0xff}, // lavender
	color.RGBA{B: 0x75, A: 0xff},                   // navy
	color.RGBA{R: 0x43, G: 0x63, B: 0xd8, A: 0xff}, // blue
	color.RGBA{R: 0xe6, G: 0x19, B: 0x4B, A: 0xff}, // red
	color.RGBA{R: 0x42, G: 0xd4, B: 0xf4, A: 0xff}, // cyan
	color.RGBA{R: 0xf0, G: 0x32, B: 0xe6, A: 0xff}, // magenta
	color.RGBA{R: 0x46, G: 0x99, B: 0x90, A: 0xff}, // teal
	color.RGBA{R: 0x9A, G: 0x63, B: 0x24, A: 0xff}, // brown
	color.RGBA{R: 0xaa, G: 0xff, B: 0xc3, A: 0xff}, // mint
	color.RGBA{R: 0x91, G: 0x1e, B: 0xb4, A: 0xff}, // purple
	color.RGBA{R: 0x80, G: 0x80, A: 0xff},          // olive
	color.RGBA{R: 0xff, G: 0xd8, B: 0xb1, A: 0xff}, // apricot
}

var specialColors = map[string]color.Color{
	"error":   color.RGBA{A: 0xff},                            // black
	"failure": color.RGBA{R: 0xf5, G: 0x82, B: 0x31, A: 0xff}, // orange
	"pending": color.RGBA{R: 0xff, G: 0xe1, B: 0x19, A: 0xff}, // yellow
	"success": color.RGBA{R: 0xa9, G: 0xa9, B: 0xa9, A: 0xff}, // gray
}
